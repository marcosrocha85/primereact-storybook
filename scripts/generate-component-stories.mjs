...
<AvatarGroup>
  ...
  },
  {
    ...
    prime: 'skeleton',
    importName: 'Skeleton',
    description: 'Loading placeholder for reserving space while content is unavailable.',
    args: `{ width: '10rem', height: '2rem', borderRadius: '16px', animation: 'wave' }`,
    ...
    docsImports: 'import { Skeleton } from "primereact/skeleton";',
    docsVariations: [
      { title: 'Shapes and sizes', code: '<Skeleton shape="circle" size="4rem" />\n<Skeleton width="10rem" height="1rem" />\n<Skeleton width="5rem" height="1rem" />' },
      { title: 'Content placeholder', code: '<div className="flex align-items-center gap-2">\n  <Skeleton shape="circle" size="4rem" />\n  <div className="flex flex-column gap-2">\n    <Skeleton width="10rem" />\n    <Skeleton width="5rem" />\n  </div>\n</div>' },
      { title: 'Static loading state', code: '<Skeleton width="100%" height="8rem" animation="none" />' }
    ],
  },
  {
    name: 'ScrollPanel',
