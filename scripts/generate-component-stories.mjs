...
const components = [
  {
    ...
    description: 'Botao dividido com acao principal e menu de opcoes.',
  ...
  },
  {
    ...
    description: 'Campo de texto base usado em formularios, filtros e buscas.',
  ...
  },
  {
    ...
    description: 'Campo com sugestoes e autocomplete.',
  ...
  },
  {
    ...
    prime: 'calendar',
    importName: 'Calendar',
    description: 'Selecionador de data.',
  ...
  },
  {
    ...
    prime: 'checkbox',
    importName: 'Checkbox',
    description: 'Controle booleano ou selecao multipla.',
  ...
  },
  {
    ...
    prime: 'chips',
    importName: 'Chips',
    description: 'Entrada de multiplos valores em formato de chips.',
  ...
  },
  {
    ...
    description: 'Selecionador visual de cor.',
    args: `{ value: '1976D2' }`,
    argTypes: `{
    value: { control: 'text' },
    disabled: { control: 'boolean' }
  ...
  },
  {
    ...
    prime: 'dropdown',
    importName: 'Dropdown',
    description: 'Selecionador de uma opcao.',
  ...
  },
  {
    ...
    description: 'Campo de texto com mascara.',
  ...
  },
  {
    ...
    description: 'Entrada numerica com formatacao.',
  ...
  },
  {
    ...
    description: 'Alternador booleano.',
    args: `{ checked: true }`,
  ...
  },
  {
    ...
    prime: 'knob',
    importName: 'Knob',
    description: 'Controle circular numerico.',
  ...
  },
  {
    ...
    description: 'Selecionador de multiplas opcoes.',
  ...
  },
  {
    ...
    prime: 'password',
    importName: 'Password',
    description: 'Entrada de senha com feedback.',
  ...
  },
  {
    ...
    description: 'Opcao unica em grupo.',
  ...
  },
  {
    ...
    prime: 'rating',
    importName: 'Rating',
    description: 'Avaliacao por estrelas.',
  ...
  },
  {
    ...
    description: 'Selecao por botoes.',
  ...
  },
  {
    ...
    prime: 'slider',
    importName: 'Slider',
    description: 'Controle de valor por intervalo.',
  ...
  },
  {
    ...
    description: 'Botao liga/desliga.',
  ...
  },
  {
    ...
    description: 'Tabela de dados com filtros, selecao, expansao e agrupamento.',
  ...
  },
  {
    ...
    prime: 'dataview',
    importName: 'DataView',
    description: 'Visualizacao de colecoes em lista ou grid.',
  ...
  },
  {
    ...
    prime: 'picklist',
    importName: 'PickList',
    description: 'Transferencia entre listas.',
  ...
  },
  {
    ...
    prime: 'tree',
    importName: 'Tree',
    description: 'Estrutura hierarquica expansivel.',
  ...
  },
  {
    ...
    extraImports: `import { Column } from 'primereact/column';`,
    description: 'Tabela hierarquica.',
  ...
  },
  {
    ...
    description: 'Conteudo expansivel em abas verticais.',
    args: `{ activeIndex: 0 }`,
  ...
  },
  {
    ...
    description: 'Navegacao por abas.',
    args: `{ activeIndex: 0 }`,
    argTypes: `{ activeIndex: { control: 'number' } }`,
  ...
  },
  {
    ...
    prime: 'panel',
    importName: 'Panel',
    description: 'Container com cabecalho e opcao toggleable.',
  ...
  },
  {
    ...
    prime: 'fieldset',
    importName: 'Fieldset',
    description: 'Agrupador semantico com legenda.',
  ...
  },
  {
    ...
    prime: 'card',
    importName: 'Card',
    description: 'Container de conteudo com titulo, subtitulo e footer.',
  ...
  },
  {
    ...
    description: 'Layout redimensionavel por paineis.',
  ...
  },
  {
    ...
    extraImports: `import { Button } from 'primereact/button';`,
    description: 'Painel flutuante acionado por evento.',
    args: `{}`,
    argTypes: `{}`,
  ...
  },
  {
    ...
    extraImports: `import { Button } from 'primereact/button';`,
    description: 'Confirmacao contextual.',
    args: `{}`,
    argTypes: `{}`,
  ...
  },
  {
    ...
    prime: 'menubar',
    importName: 'Menubar',
    description: 'Menu horizontal principal.',
  ...
  },
  {
    ...
    description: 'Trilha de navegacao.',
  ...
  },
  {
    ...
    prime: 'menu',
    importName: 'Menu',
    description: 'Menu vertical simples ou popup.',
  ...
  },
  {
    ...
    description: 'Menu acionado por contexto.',
  ...
  },
  {
    ...
    prime: 'megamenu',
    importName: 'MegaMenu',
    description: 'Menu amplo com agrupamentos.',
  ...
  },
  {
    ...
    description: 'Menu em paineis expansivos.',
    renderPrefix: `const items = [{ label: 'Customers', icon: 'pi pi-fw pi-table', items: [{ label: 'New', icon: 'pi pi-fw pi-plus' }] }];`,
  ...
  },
  {
    ...
    prime: 'messages',
    importName: 'Messages',
    description: 'Lista de mensagens programaticas.',
    args: `{}`,
    argTypes: `{}`,
    playground: `<Messages />`,
  ...
  },
  {
    ...
    prime: 'carousel',
    importName: 'Carousel',
    description: 'Carrossel de itens.',
  ...
  },
  {
    ...
    prime: 'image',
    importName: 'Image',
    description: 'Imagem com preview opcional.',
  ...
  },
  {
    ...
    description: 'Upload de arquivos basico ou avancado.',
  ...
  },
  {
    ...
    prime: 'chart',
    importName: 'Chart',
    description: 'Graficos baseados em Chart.js.',
  ...
  },
  {
    ...
    prime: 'badge',
    importName: 'Badge',
    description: 'Marcador numerico ou status.',
  ...
  },
  {
    ...
    prime: 'avatar',
    importName: 'Avatar',
    description: 'Representacao visual de usuario ou entidade.',
  ...
  },
  {
    ...
    prime: 'chip',
    importName: 'Chip',
    description: 'Chip textual, com icone ou imagem.',
  ...
  },
  {
    ...
    description: 'Area com scroll customizado.',
  ...
  },
  {
    ...
    description: 'Atalho para voltar ao topo.',
...
<Meta title="Components/${component.name}/Resumo" />
